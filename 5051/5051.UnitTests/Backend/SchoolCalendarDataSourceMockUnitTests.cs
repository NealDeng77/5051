...
namespace _5051.UnitTests.Models
{
    ...
    public class SchoolCalendarDataSourceMockUnitTests
    {
        ...
        #region read
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Read_Invalid_ID_Null_Should_Fail()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
        ...
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Read_Valid_ID_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
        ...
        #region update
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Update_Invalid_Data_Null_Should_Fail()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
        ...
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Update_Valid_Data_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
            var schoolCalendarBackend = SchoolCalendarBackend.Instance;
        ...
        #region delete
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Delete_Invalid_ID_Null_Should_Fail()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
            var expect = false;
        ...
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_Delete_Valid_ID_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
            var schoolCalendarBackend = SchoolCalendarBackend.Instance;
        ...
        #region DataSet
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_LoadDataSet_Valid_Enum_Demo_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
        ...
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_LoadDataSet_Valid_Enum_UnitTest_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
        ...
        #region ReadDate
        [TestMethod]
        public void Backend_SchoolCalendarDataSourceMock_ReadDate_Should_Pass()
        {
            // Arrange
            var backend = SchoolCalendarDataSourceMock.Instance;
