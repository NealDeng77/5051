...
namespace _5051.Backend
{
    ...
    public class FactoryInventoryDataSourceHelper
    {
        ...
        public List<FactoryInventoryModel> GetDefaultDataSet()
        {
            ...
            #region Food
            DataList.Add(new FactoryInventoryModel("GChocolate.png", "Chocolate", "Ice Cream", FactoryInventoryCategoryEnum.Food, 8, 10, false));
            DataList.Add(new FactoryInventoryModel("GCoffee.png", "Coffee", "Ice Cream", FactoryInventoryCategoryEnum.Food, 10, 10, true));
            DataList.Add(new FactoryInventoryModel("GCookiedough.png", "Cookie Dough", "Ice Cream", FactoryInventoryCategoryEnum.Food, 10, 10, true));
            DataList.Add(new FactoryInventoryModel("GMintChip.png", "Mint Chip", "Ice Cream", FactoryInventoryCategoryEnum.Food, 10, 10, true));
            DataList.Add(new FactoryInventoryModel("GSherbert.png", "Sherbert", "Sherbert", FactoryInventoryCategoryEnum.Food, 10, 10, true));
            ...
            DataList.Add(new FactoryInventoryModel("Truck2.png", "Fire", "Truck", FactoryInventoryCategoryEnum.Truck, 20, 10, false));

            DataList.Add(new FactoryInventoryModel("Trailer3.png", "Bubble", "Trailer", FactoryInventoryCategoryEnum.Trailer, 15, 10, false));
            ...
            DataList.Add(new FactoryInventoryModel("Topper1.png", "Ice Cream", "Ice Cream Topper", FactoryInventoryCategoryEnum.Topper, 15, 10, false));
            DataList.Add(new FactoryInventoryModel("Sign1.png", "Ice Cream", "Ice Cream Sign", FactoryInventoryCategoryEnum.Sign, 10, 10, false));

            DataList.Add(new FactoryInventoryModel("Menu2.png", "Taco", "Taco Menu", FactoryInventoryCategoryEnum.Menu, 10, 10, false));
            DataList.Add(new FactoryInventoryModel("Topper2.png", "Taco", "Taco Topper", FactoryInventoryCategoryEnum.Topper, 15, 10, false));
            DataList.Add(new FactoryInventoryModel("Sign2.png", "Taco", "Taco Sign", FactoryInventoryCategoryEnum.Sign, 10, 10, false));
