...
namespace _5051.Backend
{
    ...
    public class FactoryInventoryDataSourceMock : IFactoryInventoryInterface
    {
        ...
        private void DataSetDefault()
        {
            ...
            Create(new FactoryInventoryModel("GCoffee.png", "Coffee Gallon", "Coffee Ice Cream", FactoryInventoryCategoryEnum.Food, 20, 10, true));
            Create(new FactoryInventoryModel("GCookiedough.png", "Cookie Dough Gallon", "Cookie Dough Ice Cream", FactoryInventoryCategoryEnum.Food, 20, 10, true));
            Create(new FactoryInventoryModel("GMintChip.png", "Mint Chip Gallon", "Mint Chip Ice Cream", FactoryInventoryCategoryEnum.Food, 20, 10, true));
            ...
            Create(new FactoryInventoryModel("Trailer2.png", "Taco Fire Trailer", "Tack FireTrailer", FactoryInventoryCategoryEnum.Trailer, 15, 10, false));
            Create(new FactoryInventoryModel("Truck2.png", "Taco Fire Truck", "Taco Fire Truck", FactoryInventoryCategoryEnum.Truck, 15, 10, false));
            Create(new FactoryInventoryModel("Menu2.png", "Taco Fire Menu", "Taco Fire Menu", FactoryInventoryCategoryEnum.Menu, 15, 10, false));
            Create(new FactoryInventoryModel("Topper2.png", "Taco Fire Topper", "Taco Fire Topper", FactoryInventoryCategoryEnum.Topper, 15, 10, false));
            Create(new FactoryInventoryModel("Sign2.png", "Taco Fire Sign", "Taco Fire Sign", FactoryInventoryCategoryEnum.Sign, 15, 10, false));

            Create(new FactoryInventoryModel("Trailer3.png", "Bubble Trailer", "Bubble Trailer", FactoryInventoryCategoryEnum.Trailer, 20, 10, false));
            Create(new FactoryInventoryModel("Truck3.png", "Bubble Truck", "Bubble Truck", FactoryInventoryCategoryEnum.Truck, 20, 10, false));
        }
