...
namespace _5051.Backend
{
    ...
    public class KioskSettingsDataSourceTable : IKioskSettingsInterface
    {
        ...
        public bool Delete(string Id)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<KioskSettingsModel>(tableName, partitionKey, myData.Id, myData);
        ...
        public void CreateDataSetDefaultData() { 
            ...
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<KioskSettingsModel>(tableName, partitionKey);
